...
<template>
  ...
  <button
    ...
    class="fixed bottom-6 right-6 w-16 h-16 rounded-full bg-[#f8d210] text-black shadow-lg hover:shadow-xl active:scale-95 transition-all flex items-center justify-center z-50"
